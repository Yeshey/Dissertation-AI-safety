...
\section{Per Category Results Analysis}\label{subsec:results_categories}
		...
		In this section, an analysis of the resulting articles in each category is conducted and discussed. Furthermore, an analysis is made on how crucial each category of research is in its contribution to stopping potential devastating outcomes. 
