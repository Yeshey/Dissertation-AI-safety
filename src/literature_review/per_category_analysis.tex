...
\begin{toreview}
		\subsection*{Auditing, Safety \& Oversight}
			...
			This category covers Scalable Oversight, exploring whether weaker models can reliably supervise more capable ones, increasingly important as new models capabilities begin to exceed human evaluative capacity \cite{bowman2022measuring}. A central tension identified in the literature is between rigorous safety evaluation and practical feasibility: \citeauthor{GapsSafetyEval2024} \cite{GapsSafetyEval2024} find systematic gaps in how generative \gls{ai} is evaluated, while \citeauthor{RajiDobbe2024} \cite{RajiDobbe2024} show that foundational safety problems identified a decade ago like safe exploration and distributional shift, remain largely unsolved in deployed systems.
