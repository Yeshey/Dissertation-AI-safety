...
\label{sec:slr_protocol}

The systematic literature search was executed using target databases and snowballing techniques to capture recent developments. The intended literature was captured by:
	...
	\begin{table}[htbp]
		\centering
		\caption{Selection filters to narrow down related work for the \gls{slr}}
		...
		\begin{threeparttable}
			\begin{tabular}{lcccccc}
				...
				\midrule
				\textbf{Total}    & 6668                                                                                                                   & 3241                                                                                                                  & 125                                                                                                                   & 79                & 63                & 80                   \\
				\bottomrule
			\end{tabular}
			\begin{tablenotes}
				\small
	...
	A noteworthy consideration is the growth that the \gls{ai} safety field has experienced in the past couple of years. Since the advent of \glspl{llm}, \gls{ai} has been a booming topic; this can be verified in the volume of publications, as shown in Figure \ref{fig:ai_trends_combined}, or in the volume of web searches like shown in Figure \ref{fig:google_trends_ai_safety}.

	In much the same way, \gls{ai} safety publications have also enjoyed an increase in output, which is also reflected in Figure \ref{fig:ai_trends_combined}, especially with the release of ChatGPT on November 30, 2022. The rate of growth of AI safety publications is relatively low and with few advancements in the field, largely due to the lack of financial incentives \cite{eto_state_global_ai_research_2024, ahmed_narrow_depth_breadth_corporate_2024, hemphill_advanced_2025}. This trend can also be verified in general web searches, Figure \ref{fig:google_trends_ai_safety}.
