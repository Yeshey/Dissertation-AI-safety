	...
	\begin{table}[htbp]
		...
		\begin{threeparttable}
			\begin{tabular}{lcccccc}
				...
				\midrule
				\textbf{Total}    & 6668                                                                                                                   & 3241                                                                                                                  & 125                                                                                                                   & 79                & 63                & 76                   \\
				\bottomrule
			\end{tabular}
			\begin{tablenotes}
				\small
...
AI safety is a very broad term that is fuzzily defined, this section will compartmentalize the field into several digestible areas. A theoretical foundation will also be provided for all the most common AI safety that will be used across this work.
...
\subsection{The Why? Foundation of Dangerous AI}
...
\subsection{Alignment Solutions and Techniques and their Problems}
...
\subsection{Bias, Fairness and AI in Society}
