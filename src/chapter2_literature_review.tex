...
<TALK ABOUT HOW THE RESAERCH ON THIS HAS EVOLVED AND HOW IT HAS BEEN GROWING, LIKE IN RICARDOS THESIS>

An important consideration is the growth that the AI safety field has experienced and is still experiencing. This gives light to an increasing interest in the area. Like you can see on Figure \ref{fig:ai-safety-timegraph}.


<MAKE A GRAPH FOR INCREASING AI SAFETY RESEARCH>
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{./src/imgs/AI_Safety_timeGraph_Scopus}
  \caption{Number of documents matching the AI safety query. At the end of 2025 there were 1742 documents.}
  \label{fig:ai-safety-timegraph}
\end{figure}

However, it the rate at witch AI safety research has been growing and financed is outpaced by the rate at witch AI capabilities research has been growing like you can see on Figure \ref{fig:all-ai-timegraph} \cite{eto_state_global_ai_research_2024, ahmed_narrow_depth_breadth_corporate_2024}.
...
<MAKE A GRAPH FOR INCREASING AI SAFETY RESEARCH AGAINST GENERAL CAPABILITIES RESEARCH>
