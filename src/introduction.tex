...
\begin{reviewed}
	...
	To steer the research objectives it is helpful to determine the exact motivation behind the work. Up until now, every technological achievement merely represented an extension of our capabilities. Now, with \gls{ai}, for the first time there is the prospect of a technology that would have its own goals and be capable of substituting the inventive process itself, rendering human capabilities obsolete \cite{bostrom2014superintelligence, salmon_managing_2023}. The motivation of this work stems from the desire to keep the future human and human aligned.
