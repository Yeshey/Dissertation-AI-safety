...
\begin{reviewed}
	...
	Up until now, every technological achievement merely represented an extension of our capabilities. Now, with AI, for the first time there is the prospect of a technology that would have its own goals and be capable of substituting the inventive process itself, rendering human capabilities obsolete.
...
In the world of AI safety, there's a lot of research surrounding preventing misbehavior in a distributional shift, explainable AI, etc. The proposed hypothesis is the following:
\begin{itemize}
...
\end{itemize}
Therefore, this research will be conducted in a \gls{slr} that:
\begin{itemize}
	\item \textbf{\gls{slr}}: Aims at finding out if the current pursuit of \gls{agi} has natural dangers, how dangerous, and whether they are relevant in general or only narrow domains.
\end{itemize}
...
\begin{enumerate}
	\item \gls{rq}1. What is the main focus of current AI safety research?
	...
	\item \gls{rq}4. What metrics can be used to more clearly show potential problems with these systems?
\end{enumerate}
