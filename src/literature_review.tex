...
\chapter{Literature Review — \gls{ai} Safety}\label{chap:literature_review}
	...
	This \gls{slr} targets the continuous research in the area of \gls{ai} safety by utilizing a specific search string capable of funneling the amount of peer-reviewed articles from several known datasets:
	...
	The \gls{slr} yielded research that spanned many fields that often stray from DevOps or ML Ops pipelines. These include economics and philosophical research, political and corporate regulations and governance systems, and numerous high-level analyses of the field and current alignment or shallow alignment techniques. Technical research is typically focused on specific issues within well-defined contexts or operational environments, and therefore tends to address problems with shallow alignment \cite{milliere_normative_2025, mcintosh_inadequacy_2024}. Because of this, and since the \gls{ai} field is evolving at a pace that is sometimes hard for peer-reviewed literature to keep up with, snowballing is introduced to bring in other relevant articles and gray literature \cite{wohlin_guidelines_2014}. The related table can be found in Appendix \ref{sec:snowballing_articles_slr}.
...
A noteworthy consideration is the growth that the \gls{ai} safety field has experienced in the past couple of years. Since the advent of \glspl{llm} that \gls{ai} has been a booming topic, this can be verified in the volume of publications like can be seen in Figure \ref{fig:all-ai-timegraph}, or in the volume of web searches like shown in Figure \ref{fig:google_trends_ai_safety}.
