...
\begin{toreview}
	...
	\begin{table}[h]
		...
		\begin{tabular}{l p{5cm} l}
			\hline
			\textbf{Solution Category} & \textbf{Key Techniques} & \textbf{Primary Problem Addressed} \\ \hline
			...
			\textbf{Corrigibility} & \gls{cirl},\newline Utility Indifference & Inner Misalignment, Deceptive Alignment (Treacherous Turn) \\ 
			...
			\textbf{Containment and Restriction} & \gls{ai} Control, Boxing,\newline Oracle \gls{ai} & Deceptive Alignment (Treacherous Turn) \\ 
			\textbf{Evaluation and Responsible Deployment} & Capability Evaluations,\newline \glspl{rsp}\textsuperscript{a} & All Failure Modes (Safety Net) \\ \hline
		\end{tabular}%
		}
		\vspace{0.4em}
		\footnotesize
		\textsuperscript{a}A framework developed and used by Anthropic to mitigate catastrophic risks from AI systems\cite{anthropic2026rsp}.
	\end{table}
...
\end{toreview}
	...
	\textbf{Evaluation and Responsible Deployment} methods provide ongoing assurance after training. Dangerous Capability Evaluations test whether a model has crossed capability thresholds that trigger heightened safety requirements \cite{FLIAISafetyIndex2025, FLIAISafetyIndex2026, AISafetyReport2025}. \begin{toreview}To formalize this, frontier AI developers adopt \textbf{\glspl{rsp}}, which are formal governance and safety frameworks defined and used by Anthropic. They explicitly define in advance which safety evaluations and capability thresholds must be passed before a more capable model may be trained further or deployed, acting as a structured safety net against catastrophic risks \cite{anthropic2026rsp}.
\end{toreview}
