...
\begin{toreview}
	...
	\subsection{Mainstreaming and Existential Risk}
		...
		Nick Bostrom’s 2014 book \textit{Superintelligence} \cite{bostrom2014superintelligence} brought AI safety concerns, namely,  Existential Risk and the Control Problem, into mainstream discourse; prompting prominent tech figures like Elon Musk, Bill Gates, and Stephen Hawking to voice similar concerns. This drove significant funding into safety institutions. In 2015, the \gls{fli} awarded \$6.5 million in grants for beneficial \gls{ai} research. As deep learning accelerated, experts increasingly debated the probability of these civilizational threats \cite{field_why_2025}. Recently, safety has reached global governance, and the 2025 International \gls{ai} Safety Report, which represents an effort from the UK government to review \gls{ai} risks \cite{AISafetyReport2025}.
