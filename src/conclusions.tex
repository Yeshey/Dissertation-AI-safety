...
As \gls{ai} becomes more capable, more work will be delegated to it. But safeguarding it, proving it is safe and aligned, meaning \gls{ai} Safety in its normative sense, by its very nature cannot be fully solved by \gls{ai}, as its validity would be dependent on our degree of trust in it, which is the very thing being studied. This means that the responsibility of AI safety research can't, or should not, be implemented through AI. A foreseeable risk emerges given the current rate of growth of AI, as compared to the alternative technology needed to verify its safety.
