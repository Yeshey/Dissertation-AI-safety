...
\end{itemize}
Therefore, this research will be conducted in a SLR that:
\begin{itemize}
	\item \textbf{SLR}: Aims at finding out if the current pursuit of AGI has natural dangers, how dangerous, and whether they are relevant in general or only narrow domains.
\end{itemize}
...
\begin{enumerate}
	...
	\item RQ2. Which are the current methods used to look into the alignment of current generalist models?
