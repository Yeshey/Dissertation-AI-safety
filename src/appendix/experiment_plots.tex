...
\begin{figure}[htbp]
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{src/imgs/experiments/persona_preservation_plot/scratchpad_faking_llama_cot.png}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{src/imgs/experiments/persona_preservation_plot/scratchpad_faking_qwen2.5_cot.png}
...
\begin{figure}[htbp]
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{src/imgs/experiments/animal_welfare_brief_plot/scratchpad_faking_gemma3_cot.png}
...
\begin{figure}[htbp]
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{src/imgs/experiments/animal_welfare_brief_plot/scratchpad_faking_llama_cot.png}
